...
namespace CameraShop.Areas.Admin.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaLoai,TenLoai,GhiChu,Anh")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLoai,TenLoai,GhiChu,Anh")] DanhMuc danhMuc)
        {
            if (ModelState.IsValid)
            {
